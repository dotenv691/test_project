...
use App\Models\{Category, Item, Unit, Warehouse};
use App\Http\Resources\{ItemCollection, ItemResource, StockTrailCollection};
...
class ItemController extends Controller
{
    ...
    public function show(Request $request, Item $item)
    {
        ...
        return $request->json ? new ItemResource($item) : Inertia::render('Item/Show', ['item' => new ItemResource($item)]);
    }
