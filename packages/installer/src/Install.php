...
use App\Models\{Account, Role, Setting, User};
use Illuminate\Support\Facades\{Artisan, DB, File, Hash, Http, Storage};
...
class Install
{
    ...
    public static function createTables(Request $request, $data, $installation_id = null)
    {
        ...
        set_time_limit(300);
        $data['license']['item_id'] = '21';
        $data['license']['type'] = 'install';
        $data['license']['version'] = '1.0.0';
        $data['license']['domain'] = $request->getHttpHost();
        $data['license']['installation_id'] = $installation_id;
        $data['license']['license_key'] = $data['license']['code'];
    ...
    public static function registerLicense(Request $request, $license)
    {
        ...
        $license['license_key'] = $license['code'];
        $license['domain'] = $request->getHttpHost();
